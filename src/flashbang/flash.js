...
export function createPageElements() {
  ...
  p.innerText =
    "The photo version of cookies, but brighter. - Most websites track you with cookies. This one? It tracks you with photos! Each flash captures a moment of you while browsing, creating a unique visual 'footprint.' Don’t worry—it’s for research... we promise!";
  p.classList.add("flash-description");
